...
public interface IPeripheral {
     ...
     * This will occur when a peripheral is placed next to an active computercraft, when a computercraft is turned on
     * next to a peripheral,
     * or when a turtle travels into a square next to a peripheral.
     * Between calls to attach() and detach(), the attached computercraft can make method calls on the peripheral using
     * peripheral.call().
