...
/**
 * This class is highly derived from Minecraft's PathFinder class. As that class contains mostly I didn't see a way to
 * making this class a subclass
 * of PathFinder. And yes, there are accesstransformers, but I think copying a class is better than editing a base
 * class. Let me know if you know
...
public class PathFinderDrone {
    ...
    private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8) {
        ...
        if (canEntityDrown && par1Entity.isInWater()) {
            ...
            for (Block j = worldMap
                .getBlock(MathHelper.floor_double(par1Entity.posX), i, MathHelper.floor_double(par1Entity.posZ)); j
                    == Blocks.water
                    || j == Blocks.flowing_water; j = worldMap.getBlock(
    ...
    private int findPathOptions(Entity par1Entity, PathPoint par2PathPoint, PathPoint par3PathPoint,
        ...
        for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
            PathPoint safePoint = getSafePoint(
                par1Entity,
                par2PathPoint.xCoord + dir.offsetX,
                par2PathPoint.yCoord + dir.offsetY,
                par2PathPoint.zCoord + dir.offsetZ,
                par3PathPoint,
                b0);
    ...
    private PathPoint getSafePoint(Entity par1Entity, int par2, int par3, int par4, PathPoint par5PathPoint, int par6) {
         ...
         * }
         * if(pathpoint1 == null && par6 > 0 && i1 != -3 && i1 != -4 && getVerticalOffset(par1Entity, par2, par3 + par6,
         * par4, par5PathPoint) == 1) {
    ...
    public int getVerticalOffset(Entity par1Entity, int par2, int par3, int par4, PathPoint par5PathPoint) {
        return 1;
        // return func_82565_a(par1Entity, par2, par3, par4, par5PathPoint, isPathingInWater, isMovementBlockAllowed,
        // isWoddenDoorAllowed);
    }
