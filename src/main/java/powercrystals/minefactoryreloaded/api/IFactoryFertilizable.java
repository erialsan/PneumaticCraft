 ...
 *
 *         Defines a fertilizable block, and the process to fertilize it. You can assume that you will never have to
 *         check that block ID matches the one returned by
...
public interface IFactoryFertilizable {
     ...
     * @param z              The Z coordinate of this block.
     * @param fertilizerType The kind of fertilizer being used.
     * @return True if fertilization was successful. If false, the Fertilizer will not consume a fertilizer item and
     *         will not drain power.
     */
