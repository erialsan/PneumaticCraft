...
public interface IFactoryHarvestable {
    ...
    /**
     * @return Whether or not the Harvester should break the block when harvesting. If false, no changes will be
     ...
     * @param y                 The Y coordinate of the block being harvested.
     * @param z                 The Z coordinate of the block being harvested.
     * @return The drops generated by breaking this block. For a default implementation, calling Block.getBlockDropped()
    ...
    /**
     * Called before the block is going to be harvested, after getDrops. Usually empty.
     * 
     * @param world The world this block is in.
     * @param x     The X coordinate of the block being harvested.
     * @param y     The Y coordinate of the block being harvested.
