...
public class AspectList implements Serializable {
    ...
    public LinkedHashMap<Aspect, Integer> aspects = new LinkedHashMap<Aspect, Integer>();// aspects associated with this
                                                                                         // object
    ...
    public AspectList add(AspectList in) {
        for (Aspect a : in.getAspects()) this.add(a, in.getAmount(a));
        return this;
    }

    public AspectList merge(AspectList in) {
        for (Aspect a : in.getAspects()) this.merge(a, in.getAmount(a));
        return this;
    }
