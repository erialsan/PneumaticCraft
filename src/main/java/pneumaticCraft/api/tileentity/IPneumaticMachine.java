...
/**
 * Deprecated: Use ISidedPneumaticMachine in favor of this one. In Minecraft 1.8+ that ISidedPneumaticMachine will be
 * renamed to IPneumaticMachine, and therefore will be sided by default.
 */
@Deprecated
public interface IPneumaticMachine {
     ...
     * You can retrieve one by calling
     * {@link AirHandlerSupplier#getAirHandler(net.minecraft.tileentity.TileEntity, float, float, float, float)}.
     ...
     * to the IAirHandler.
     * Apart from that you'll need to forward
     * {@link net.minecraft.block.Block#onNeighborChange(net.minecraft.world.IBlockAccess, int, int, int, int, int, int)}
