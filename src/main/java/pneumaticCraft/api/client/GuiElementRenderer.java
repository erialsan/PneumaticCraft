...
public class GuiElementRenderer {
     ...
     * @param maxPressure        The maximal pressure that needs to be rendererd (this is 7 for tier one machines, and
     *                           25 for tier two).
     * @param dangerPressure     The transition pressure from green to red (this is 5 for tier one, and 29 for tier two
     *                           machines).
