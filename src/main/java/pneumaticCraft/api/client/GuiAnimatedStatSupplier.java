...
/**
 * With this class you can retrieve new instances of the PneumaticCraft's IGuiAnimatedStat implementation. You can use
 * these in Gui's as
 * well as anywhere you like. When you use these in Gui's you need to pass a valid GuiScreen instance, if you don't you
 * can just pass
 * null.
 */
public class GuiAnimatedStatSupplier {
    ...
    public static IGuiAnimatedStat getAnimatedStat(GuiScreen gui, ItemStack iconStack, int backgroundColor) {
        return getAnimatedStat(
            new Class[] { GuiScreen.class, int.class, ItemStack.class },
            gui,
            backgroundColor,
            iconStack);
    }
    ...
    public static IGuiAnimatedStat getAnimatedStat(GuiScreen gui, String iconTexture, int backgroundColor) {
        return getAnimatedStat(
            new Class[] { GuiScreen.class, int.class, String.class },
            gui,
            backgroundColor,
            iconTexture);
    }
    ...
    private static IGuiAnimatedStat getAnimatedStat(Class[] constructorClasses, Object... constructorParameters) {
        try {
            ...
            return (IGuiAnimatedStat) animatedStatClass.getConstructor(constructorClasses)
