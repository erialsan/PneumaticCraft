 ...
 * the
 * entity's class. If you don't have access to the class (vanilla entities), you can implement this interface in a
 * separate class
 * and register it using PneumaticRegistry.registry.addHackable(entityClass, IHackableEntityClass). In both ways there
...
public interface IHackableEntity {
    ...
    /**
     * Return the time it takes to hack this entity in ticks. For more powerful hacks, a longer required hacking time is
     * adviced.
     */
    public int getHackTime(Entity entity, EntityPlayer player);

    /**
     * When the player hacked the entity for getHackTime(Entity) ticks this will be called on both client and server
     * side.
     */
    public void onHackFinished(Entity entity, EntityPlayer player);

    /**
     * Called every tick after the hacking finished. Returning true will keep this going (for mob spawners, to keep them
     * neutralized),
