 ...
 * There needs to be a parameterless constructor. For every entity that's applicable for this definition, an instance is
 * created.
 */
public interface IEntityTrackEntry {
    ...
    /**
     * Update is called every (client) tick, and can be used to update something like a timer (used for the Creeper
     * countdown).
     * 
     * @param entity
     */
