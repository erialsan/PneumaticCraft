 ...
 * interface
 * which is used many times in PneumaticCraft (GUI stats, Pneumatic Helmet 2D and 3D stats). You can get an instance of
 * this
 * class as well. Information about this you can find in GuiAnimatedStatSupplier.java. Implementing your own version of
 * animated stats can be implemented as well via this interface, and they will interact with the PneumaticCraft
 * GuiAnimatedStats
...
public interface IGuiAnimatedStat {
     ...
     * dimensions.
     * Used in PneumaticCraft by the block/entity tracker stats, they are 0x0 when not expanded so it looks like they
     * expand
