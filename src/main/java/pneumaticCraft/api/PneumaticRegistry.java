...
public class PneumaticRegistry {
    ...
    /**
     * This field, which is initialized in PneumaticCraft's preInit, will give you access to various registration and
     * access options.
     * 
    ...
    public static interface IPneumaticCraftInterface {
        ...
        /**
         * Returns a list of all current successful hacks of a given entity. This is used for example in Enderman
         * hacking, so the user
         * can only hack an enderman once (more times wouldn't have any effect). This is mostly used for display
         * purposes.
         * 
         * @param entity
        ...
        /**
         * Normally drones will pathfind through any block that doesn't have any collisions (Block#getBlocksMovement
         * returns true).
        ...
        /**
         * Will spawn in a Drone a distance away from the given coordinate. When there is an inventory at the given
         * x,y,z the drone will export the items in there. If there isn't or items don't fit, the drone will travel to 5
         * blocks above the specified
         * y level, and drop the deliveredStacks. When there isn't a clear path for the items to fall these 5 blocks the
         * Drone will deliver at a
         * y level above the specified y that _is_ clear. If no clear blocks can be found (when there are only solid
         * blocks), the Drone will
         * drop the items very high up in the air instead, and drop them there.
         * 
         * When the Drone is tried to be caught by a player (by wrenching it), the drone will only the drop the items
         * that it was delivering (or
         * none if it dropped those items already). The Drone itself never will be dropped.
         * 
         * @param x
         * @param y
         * @param z
         * @param deliveredStacks stacks that are delivered by the drone. When no stacks, or more than 65 stacks are
         *                        given, this will generate an IllegalArgumentException.
        ...
        /**
         * The opposite of deliverItemsAmazonStyle. Will retrieve the queried items from an inventory at the specified
         * location.
         * 
         * @param world
         * @param x
        ...
        /**
         * Similar to deliverItemsAmazonStyle, but with Fluids. Will spawn in a Drone that will fill an IFluidHandler at
         * the given x,y,z. If the fluid doesn't fit or there isn't a IFluidHandler, the fluid is lost.
         * 
         * @param world
         * @param x
         * @param y
        ...
        /**
         * The opposite of deliverFluidAmazonStyle. Will retrieve the queried fluid from an IFluidHandler at the
         * specified location.
         * 
         * @param world
         * @param x
        ...
        /**
         * Returns the amount of Security Stations that disallow interaction with the given coordinate for the given
         * player.
         ...
         */
        public int getProtectingSecurityStations(World world, int x, int y, int z, EntityPlayer player,
            boolean showRangeLines);

        /**
         * Use this to register ISimpleBlockRenderHandler render id's of full blocks, those of which should be able to
         * be used for the Pneumatic Door Base camouflage.
         * 
         * @param id
         */
         ...
         * 
         * @param fluid
         * @param liquidToPointRatio The amount of liquid (in mB) used to get one XP point. In OpenBlocks this is 20
         *                           (mB/point).
         */
