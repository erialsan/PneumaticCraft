...
public class ItemSupplier {
    ...
    /*
     * The following is a list of all the item names that can be passed as argument in getItem(String) to get a
     * PneumaticCraft item.
     * GPSTool Currently tracked coordinated is stored in NBT, with 'x', 'y', 'z' being the tag names for the x,y and z
