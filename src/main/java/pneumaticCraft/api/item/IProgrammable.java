...
public interface IProgrammable {
    ...
    /**
     * When returned true, Programming Puzzles are needed to program this item. When returned false, it's free to
     * program.
    ...
    /**
     * When returned true, the implementing item will get a tooltip added of the summary of puzzles used in the stored
     * program.
     * 
     * @return
     */
