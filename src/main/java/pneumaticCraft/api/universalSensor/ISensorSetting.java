...
public interface ISensorSetting {
     ...
     * For instance, when the sensor should be located in player and is called speed, you should return
     * "entityTracker/player/speed".
     * "entityTracker" indicates that this sensor needs an Entity Tracker upgrade to run. You can choose from the
     * following upgrades:
     * 
     * -entityTracker
     * -blockTracker
     ...
     * "entityTracker_speed" will only let the sensor be chosen when both an Entity Tracker and a Speed Upgrade are
     * inserted.
     * 
     * @return
     */
    ...
    /**
     * Not being used at the moment, I recommend returning null for now. It is going to be used to allow sensors to
     * decide their
     * status on a item which can be inserted in a slot in the GUI if this method returns a rectangle with the
     * coordinates of
     * the slot.
     * 
     * @return
