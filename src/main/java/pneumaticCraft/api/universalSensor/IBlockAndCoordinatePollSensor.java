...
public interface IBlockAndCoordinatePollSensor {
    ...
    /**
     * See {@link IPollSensorSetting#getRedstoneValue(World, int, int, int, int, String)} , but this has the GPS tracked
     * coordinates
     * as extra parameters. This method will only invoke with a valid GPS tool, and when all the coordinates are within
     * range.
     * 
     * @param world
     * @param x
     ...
     * @param sensorRange
     * @param textBoxText
     * @param positions   When only one GPS Tool is inserted this contains the position of just that tool. If two GPS
     *                    Tools are inserted, These are both corners of a box, and every coordinate in this box is added
     *                    to the positions argument.
     * @return
     */
