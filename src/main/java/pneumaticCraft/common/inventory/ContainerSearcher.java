...
public class ContainerSearcher extends Container {
    ...
    public boolean canInteractWith(EntityPlayer player) {
        return player.getCurrentArmor(3) != null && player.getCurrentArmor(3)
        ...
        for (int k = 0; k < 6; ++k) {
            for (int l = 0; l < 8; ++l) {
                ...
                if (i1 >= 0 && i1 < itemList.size()) {
                    ...
                    gui.getInventory()
                        .setInventorySlotContents(l + k * 8, (ItemStack) null);
                }
            }
        }
    }
    ...
    @Override
    public void putStackInSlot(int par1, ItemStack par2ItemStack) {} // override this to do nothing, as NEI tries to
                                                                     // place items in this container which makes it
                                                                     // crash.
