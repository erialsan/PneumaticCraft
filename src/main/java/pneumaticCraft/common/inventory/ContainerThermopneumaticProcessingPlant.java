...
public class ContainerThermopneumaticProcessingPlant
    extends ContainerPneumaticBase<TileEntityThermopneumaticProcessingPlant> {
    ...
    public ContainerThermopneumaticProcessingPlant(InventoryPlayer inventoryPlayer,
        ...
        for (int i = 0; i < 4; i++) addSlotToContainer(new SlotUpgrade(te, i, 80 + 18 * i, 93));
