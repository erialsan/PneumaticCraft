...
public class Fluids {
    ...
    public static final Fluid oil = new FluidPneumaticCraft("oil").setDensity(800)
        .setViscosity(10000);
    ...
    private static Map<String, Block> fluidToBlockMap = new HashMap<String, Block>();// you could theoretically use
                                                                                     // fluid.getBlock(), but other mods
                                                                                     // like GregTech break it for some
                                                                                     // reason.
    ...
    public static void initFluids() {
        ...
        plastic.getBlock()
            .setBlockName(plastic.getName() + "Block");
        ...
        PneumaticRegistry.getInstance()
            .registerFuel(oil, 150000);
        PneumaticRegistry.getInstance()
            .registerFuel(diesel, 700000);
        PneumaticRegistry.getInstance()
            .registerFuel(kerosene, 1100000);
        PneumaticRegistry.getInstance()
            .registerFuel(gasoline, 1500000);
        PneumaticRegistry.getInstance()
            .registerFuel(lpg, 1800000);
    ...
    public static boolean areFluidsEqual(Fluid fluid1, Fluid fluid2) {
        ...
        return fluid1.getName()
            .equals(fluid2.getName());
    }
    ...
    private static void initializeFluidBlocksAndBuckets() {
        for (final Fluid fluid : fluids) {
            ...
            Item fluidBucket = new ItemBucket(fluidBlock) {
                ...
                @Override
                public void addInformation(ItemStack p_77624_1_, net.minecraft.entity.player.EntityPlayer p_77624_2_,
                ...
                .setTextureName(Textures.ICON_LOCATION + fluid.getName() + "Bucket")
                .setUnlocalizedName(fluid.getName() + "Bucket");
