...
public class ChunkPositionSorter implements Comparator<ChunkPosition> {
    ...
    public int compare(ChunkPosition c1, ChunkPosition c2) {
        return Double.compare(
            PneumaticCraftUtils.distBetween(c1.chunkPosX, c1.chunkPosY, c1.chunkPosZ, x, y, z),
            PneumaticCraftUtils.distBetween(c2.chunkPosX, c2.chunkPosY, c2.chunkPosZ, x, y, z));
    }
}
