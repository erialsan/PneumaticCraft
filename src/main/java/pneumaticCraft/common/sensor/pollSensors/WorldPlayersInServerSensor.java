...
public class WorldPlayersInServerSensor implements IPollSensorSetting {
    ...
    public List<String> getDescription() {
        ...
        text.add(
            EnumChatFormatting.BLACK
                + "When you fill in a specific player name, the Universal Sensor will emit a redstone signal of 15 if the player is online and 0 otherwise.");
        return text;
    }
    ...
    public int getRedstoneValue(World world, int x, int y, int z, int sensorRange, String textBoxText) {
        ServerConfigurationManager serverManager = FMLCommonHandler.instance()
