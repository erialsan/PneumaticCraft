            ...
            if (block.hasComparatorInputOverride()) {
                for (int i = 0; i < 6; i++) {
                    maxStrength = Math.max(
                        maxStrength,
                        block.getComparatorInputOverride(world, pos.chunkPosX, pos.chunkPosY, pos.chunkPosZ, i));
                }
            }
        }
        return maxStrength;
