    ...
    public List<String> getDescription() {
        ...
        text.add(
            EnumChatFormatting.BLACK
                + "Emits a redstone signal if there's a block (no air) at the location stored in the GPS Tool. In case of multiple locations, if any of the locations contains a block a redstone signal will be emitted.");
        return text;
    }
