...
public class TileEntityVortexTube extends TileEntityPneumaticBase implements IHeatExchanger {
    ...
    private final IHeatExchangerLogic coldHeatExchanger = PneumaticRegistry.getInstance()
        .getHeatExchangerLogic();
    private final IHeatExchangerLogic hotHeatExchanger = PneumaticRegistry.getInstance()
        .getHeatExchangerLogic();
    private final IHeatExchangerLogic connectingExchanger = PneumaticRegistry.getInstance()
        .getHeatExchangerLogic();
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            coldHeatExchanger.update();// Only update the cold and connecting side, the hot side is handled in
                                       // TileEntityBase.
            ...
            coldHeatLevel = TileEntityCompressedIronBlock
                .getHeatLevelForTemperature(coldHeatExchanger.getTemperature());
