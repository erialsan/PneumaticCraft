            ...
            switch (laserStep) {
                ...
                default: // 4-103
                    ...
                    targetAngles[EnumAngles.BASE.ordinal()] = 100F
                        - (float) PneumaticCraftUtils.sin[(laserStep - 4) * PneumaticCraftUtils.circlePoints / 100]
                            * ITEM_SIZE;
                    targetAngles[EnumAngles.MIDDLE.ordinal()] = -10F
                        + (float) PneumaticCraftUtils.sin[(laserStep - 4) * PneumaticCraftUtils.circlePoints / 100]
                            * ITEM_SIZE;
                    targetAngles[EnumAngles.TAIL.ordinal()] = 0F;
                    targetAngles[EnumAngles.TURN.ordinal()] += (float) PneumaticCraftUtils.sin[(laserStep - 4)
                        * PneumaticCraftUtils.circlePoints
                        / 100] * ITEM_SIZE * 0.03D;
                    break;
            }
