...
public class TileEntityElectrostaticCompressor extends TileEntityPneumaticBase implements IInventory, IRedstoneControl {
    ...
    public TileEntityElectrostaticCompressor() {
        super(
            PneumaticValues.DANGER_PRESSURE_ELECTROSTATIC_COMPRESSOR,
            PneumaticValues.MAX_PRESSURE_ELECTROSTATIC_COMPRESSOR,
            PneumaticValues.VOLUME_ELECTROSTATIC_COMPRESSOR);
    ...
    public void updateEntity() {
        /*
         * Most of the Electrostatic Compressor's logic can be found in
         * TickHandlerPneumaticCraft#handleElectrostaticGeneration().
         */
    ...
    public void onStruckByLightning() {
        ...
        if (getPressure(ForgeDirection.UNKNOWN) > PneumaticValues.DANGER_PRESSURE_ELECTROSTATIC_COMPRESSOR) {
            ...
            int tooMuchAir = (int) ((getPressure(ForgeDirection.UNKNOWN)
                - PneumaticValues.DANGER_PRESSURE_ELECTROSTATIC_COMPRESSOR) * volume);
