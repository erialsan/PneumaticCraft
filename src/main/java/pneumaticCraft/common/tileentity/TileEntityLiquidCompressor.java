...
public class TileEntityLiquidCompressor extends TileEntityPneumaticBase
    implements IInventory, IRedstoneControlled, IFluidHandler {
        ...
        if (!worldObj.isRemote) {
            ...
            if (redstoneAllows()) {
                ...
                if (internalFuelBuffer >= usageRate) {
                    ...
                    addAir(
                        (int) (getBaseProduction() * this.getSpeedMultiplierFromUpgrades() * getEfficiency() / 100),
