...
public class ActionWidgetButton extends ActionWidgetVariable<GuiButtonSpecial> implements IActionWidgetLabeled {
    ...
    public ChunkPosition settingCoordinate = new ChunkPosition(0, 0, 0);// The coordinate the variable is set to when
    ...
    public void readFromNBT(NBTTagCompound tag, int guiLeft, int guiTop) {
        ...
        widget = new GuiButtonSpecial(
            ...
            tag.getString("text"));
        settingCoordinate = new ChunkPosition(
            tag.getInteger("settingX"),
            tag.getInteger("settingY"),
            tag.getInteger("settingZ"));
