        ...
        return new DroneAIBlockCondition(drone, (ProgWidgetAreaItemBase) widget) {
            ...
            protected boolean evaluate(ChunkPosition pos) {
                ...
                if (te instanceof IFluidHandler) {
                        ...
                        if (((ISidedWidget) widget).getSides()[i]) {
                            ...
                            if (info != null) {
                                for (FluidTankInfo inf : info) {
                                    if (inf.fluid != null && !visitedStacks.contains(visitedStacks)
                                        && ProgWidgetLiquidFilter.isLiquidValid(inf.fluid.getFluid(), widget, 1)) {
                    ...
                    if (fluid != null && ProgWidgetLiquidFilter.isLiquidValid(fluid, widget, 1)
