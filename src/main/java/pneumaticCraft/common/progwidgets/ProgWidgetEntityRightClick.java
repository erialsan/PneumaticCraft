        ...
        return new DroneEntityBase<IProgWidget, EntityLivingBase>(drone, widget) {
            ...
            protected boolean doAction() {
                ...
                if (stack != null && stack.getItem()
                    .itemInteractionForEntity(stack, drone.getFakePlayer(), targetedEntity)) {
                    activated = true;
                }
                if (!activated && targetedEntity instanceof EntityAgeable
                    && ((EntityAgeable) targetedEntity).interact(drone.getFakePlayer())) {
                    activated = true;
                }
