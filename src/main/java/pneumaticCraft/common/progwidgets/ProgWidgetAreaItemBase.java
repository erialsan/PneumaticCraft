...
public abstract class ProgWidgetAreaItemBase extends ProgWidget
    ...
    public static void getArea(Set<ChunkPosition> area, ProgWidgetArea whitelistWidget,
    ...
    public boolean isItemValidForFilters(ItemStack item, int blockMetadata) {
        return ProgWidgetItemFilter.isItemValidForFilters(
            item,
    ...
    public static List<Entity> getValidEntities(World world, IProgWidget widget) {
        StringFilterEntitySelector whitelistFilter = getEntityFilter(
            (ProgWidgetString) widget.getConnectedParameters()[1],
            true);
        StringFilterEntitySelector blacklistFilter = getEntityFilter(
            (ProgWidgetString) widget.getConnectedParameters()[widget.getParameters().length + 1],
            false);
        return getEntitiesInArea(
    ...
    public static List<Entity> getEntitiesInArea(ProgWidgetArea whitelistWidget, ProgWidgetArea blacklistWidget,
        World world, IEntitySelector whitelistFilter, IEntitySelector blacklistFilter) {
