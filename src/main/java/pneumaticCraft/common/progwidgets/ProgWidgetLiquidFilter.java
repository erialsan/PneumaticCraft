...
public class ProgWidgetLiquidFilter extends ProgWidget {
    ...
    public static boolean isLiquidValid(Fluid fluid, IProgWidget mainWidget, int filterIndex) {
        ProgWidgetLiquidFilter widget = (ProgWidgetLiquidFilter) mainWidget
            .getConnectedParameters()[mainWidget.getParameters().length + filterIndex];
        while (widget != null) {
    ...
    public static boolean isLiquidValid(Fluid fluid, List<ProgWidgetLiquidFilter> whitelist,
        List<ProgWidgetLiquidFilter> blacklist) {
    ...
    public String getExtraStringInfo() {
        return fluid != null ? fluid.getLocalizedName(new FluidStack(fluid, 1))
