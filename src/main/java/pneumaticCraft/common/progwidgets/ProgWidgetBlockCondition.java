    ...
    protected DroneAIBlockCondition getEvaluator(IDroneBase drone, IProgWidget widget) {
        return new DroneAIBlockCondition(drone, (ProgWidgetAreaItemBase) widget) {
            ...
            protected boolean evaluate(ChunkPosition pos) {
                if (checkingForAir && drone.getWorld()
                    .isAirBlock(pos.chunkPosX, pos.chunkPosY, pos.chunkPosZ)) return true;
                if (checkingForLiquids && PneumaticCraftUtils.isBlockLiquid(
                    drone.getWorld()
            ...
            public void initGui() {
                ...
                addWidget(
                    new GuiCheckBox(
                        ...
                        guiTop + 60,
                        0xFF000000,
                        I18n.format("gui.progWidget.conditionBlock.checkForAir")).setChecked(checkingForAir)
                ...
                addWidget(
                    new GuiCheckBox(
                        ...
                        guiTop + 72,
                        0xFF000000,
                        I18n.format("gui.progWidget.conditionBlock.checkForLiquids")).setChecked(checkingForLiquids)
