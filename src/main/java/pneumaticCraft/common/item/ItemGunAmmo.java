...
public class ItemGunAmmo extends ItemPneumatic {
    ...
    public static ItemStack getPotion(ItemStack ammo) {
        if (ammo.getTagCompound() != null && ammo.getTagCompound()
            .hasKey("potion")) {
    ...
    public int getColorFromItemStack(ItemStack itemStack, int renderPass) {
        ...
        return renderPass == 0 ? super.getColorFromItemStack(itemStack, renderPass)
            : potion != null ? Items.potionitem.getColorFromItemStack(potion, 0) : 0x00FFFF00;
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List infoList, boolean extraInfo) {
        ...
        if (potion != null) {
            potion.getItem()
                .addInformation(potion, player, infoList, extraInfo);
