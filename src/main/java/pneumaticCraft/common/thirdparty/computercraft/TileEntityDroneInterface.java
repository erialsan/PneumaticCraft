...
public class TileEntityDroneInterface extends TileEntity implements IPeripheral, ManagedPeripheral, SimpleComponent {
            ...
            if (worldObj.isRemote) {
                ...
                if (ringSendList.size() > 0 && ringSendCooldown <= 0) {
                    ...
                    NetworkHandler.sendToDimension(
                        new PacketSpawnRing(xCoord + 0.5, yCoord + 0.8, zCoord + 0.5, drone, ringSendList.remove(0)),
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt) {
        Entity entity = worldObj.getEntityByID(
            pkt.func_148857_g()
                .getInteger("drone"));
    ...
    public TileEntityDroneInterface() {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    throw new IllegalArgumentException(
                        "No valid order. Valid arguments:  'closest', 'highToLow' or 'lowToHigh'!");
                } else {
                    throw new IllegalArgumentException(
                        "setBlockOrder takes one argument, 'closest', 'highToLow' or 'lowToHigh'!");
                }
            }
        });
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 3) {
                    ...
                    getWidget().addArea(
                        ...
                        ((Double) args[1]).intValue(),
                        ((Double) args[2]).intValue(),
                        ((Double) args[3]).intValue(),
                        ((Double) args[4]).intValue(),
                        ((Double) args[5]).intValue(),
                        (String) args[6]);
                    messageToDrone(ProgWidgetArea.class);
                    return null;
                } else {
                    throw new IllegalArgumentException(
                        "addArea either requires 3 arguments (x, y, z), or 7 (x1, y1, z1, x2, y2, z2, areaType)!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("removeArea") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 3) {
                    ...
                    throw new IllegalArgumentException(
                        "removeArea either requires 3 arguments (x, y, z), or 7 (x1, y1, z1, x2, y2, z2, areaType)!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("showArea") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 0) {
                    ...
                    NetworkHandler.sendToDimension(
                        new PacketShowArea(xCoord, yCoord, zCoord, area),
                        worldObj.provider.dimensionId);
                    return null;
                } else {
        ...
        luaMethods.add(new LuaMethod("hideArea") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 0) {
                    NetworkHandler
                        .sendToDimension(new PacketShowArea(xCoord, yCoord, zCoord), worldObj.provider.dimensionId);
                    return null;
                } else {
        ...
        luaMethods.add(new LuaMethod("addWhitelistItemFilter") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 6) {
                    getWidget().addWhitelistItemFilter(
                        (String) args[0],
                        ((Double) args[1]).intValue(),
                        (Boolean) args[2],
                        (Boolean) args[3],
                    ...
                    throw new IllegalArgumentException(
                        "addWhitelistItemFilter takes 6 arguments (<string> item/block name, <number> item/block metadata, <bool> Use Metadata, <bool> Use NBT, <bool> Use Ore Dictionary, <bool> Use Mod Similarity)!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("addBlacklistItemFilter") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 6) {
                    getWidget().addBlacklistItemFilter(
                        (String) args[0],
                        ((Double) args[1]).intValue(),
                        (Boolean) args[2],
                        (Boolean) args[3],
                    ...
                    throw new IllegalArgumentException(
                        "addBlacklistItemFilter takes 6 arguments (<string> item/block name, <number> item/block metadata, <bool> Use Metadata, <bool> Use NBT, <bool> Use Ore Dictionary, <bool> Use Mod Similarity)!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("setDropStraight") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    throw new IllegalArgumentException(
                        "setDropStraight takes 1 argument (boolean straight true/false!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("setIsAndFunction") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    throw new IllegalArgumentException(
                        "setIsAndFunction takes 1 argument (boolean is and function true/false!");
                }
            }
        });
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 0) {
                    if (curAction instanceof ICondition) {
                        ...
                        throw new IllegalArgumentException(
                            "current action is not a condition! Action: "
                                + (curAction != null ? curAction.getWidgetString() : "no action"));
                    }
                } else {
        ...
        luaMethods.add(new LuaMethod("setUseMaxActions") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    throw new IllegalArgumentException(
                        "setUseMaxActions takes 1 argument (boolean use max actions true/false!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("setPlaceFluidBlocks") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    throw new IllegalArgumentException(
                        "setPlaceFluidBlocks takes 1 argument (boolean is sneaking true/false!");
                }
            }
        });
        ...
        luaMethods.add(new LuaMethod("setAction") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 1) {
                    ...
                    for (IProgWidget widget : WidgetRegistrator.registeredWidgets) {
                        if (widget.getWidgetString()
                            .equalsIgnoreCase(widgetName)) {
                            EntityAIBase ai = widget.getWidgetAI(drone, getWidget());
                            if (ai == null || !widget.canBeRunByComputers(drone, getWidget()))
                                throw new IllegalArgumentException(
                                    "The parsed action is not a runnable action! Action: \"" + widget.getWidgetString()
                                        + "\".");
        ...
        luaMethods.add(new LuaMethod("setVariable") {
            ...
            public Object[] call(Object[] args) throws Exception {
                if (args.length == 2 || args.length == 4) {
                    ...
                    throw new IllegalArgumentException(
                        "setVariable takes 2 or 4 arguments (<variable name>, <true/false>), or (<variable name>, <x> [, <y>, <z>])!");
                }
            }
    ...
    public String[] getMethodNames() {
        ...
        for (int i = 0; i < methodNames.length; i++) {
            methodNames[i] = luaMethods.get(i)
                .getMethodName();
        }
        return methodNames;
    }
    ...
    public boolean equals(IPeripheral other) {
        ...
        if (other instanceof TileEntity) {
            ...
            return tother.getWorldObj()
                .equals(worldObj) && tother.xCoord == xCoord
                && tother.yCoord == yCoord
                && tother.zCoord == zCoord;
        }
    ...
    private DroneAICC getAI() throws Exception {
        ...
        setDrone(null);// set to null in case of the drone is connected, but for some reason isn't currently running the
                       // piece (shouldn't be possible).
    ...
    private DroneAICC getTargetAI() throws Exception {
        if (drone != null && drone.getRunningTargetAI() instanceof DroneAICC) {
            ...
            setDrone(null);// set to null in case of the drone is connected, but for some reason isn't currently running
                           // the piece (shouldn't be possible).
            throw new IllegalStateException("There's no connected Drone!");
        }
    }
    ...
    private void messageToDrone(Class<? extends IProgWidget> widget) {
        messageToDrone(
            ItemDye.field_150922_c[ItemProgrammingPuzzle.getWidgetForClass(widget)
                .getCraftingColorIndex()]);
    }
