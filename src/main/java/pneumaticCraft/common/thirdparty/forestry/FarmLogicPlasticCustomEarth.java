...
public abstract class FarmLogicPlasticCustomEarth extends FarmLogicPlasticNormal {
    ...
    protected IFarmLogic getFarmLogic(IFarmHousing housing) throws Throwable {
        ...
        Constructor c = getLogicClass("FarmLogicArboreal")
            .getConstructor(IFarmHousing.class, ItemStack[].class, ItemStack.class, Iterable.class);
        return (IFarmLogic) c
            .newInstance(housing, resources, resources[0], Arrays.asList(new FarmablePlastic(getBlock())));
    }
