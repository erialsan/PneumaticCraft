...
public class Thaumcraft implements IThirdParty, IRegistryListener {
    ...
    public void preInit() {
        for (int i = 0; i < 16; i++) {
            ...
            if (plantBlock != null) {
                ...
                FMLInterModComms
                    .sendMessage(ModIds.THAUMCRAFT, "harvestStandardCrop", new ItemStack(plantBlock, 1, 13));
            }
        }
        PneumaticRegistry.getInstance()
            .registerBlockTrackEntry(new BlockTrackEntryThaumcraft());
    }
    ...
    public void init() {
        ...
        if (shard != null) {
            GameRegistry.addRecipe(
                new ItemStack(Itemss.machineUpgrade, 1, 10),
                "lal",
                "bcd",
                "lel",
                'l',
            ...
            Log.error(
                "Thaumcraft shard item couldn't be found! Registry name has changed? Thaumcraft Upgrade has no recipe!");
        }
    }
    ...
    public void postInit() {
        ...
        ThaumcraftApi.registerObjectTag(
            new ItemStack(Itemss.turbineBlade),
            new AspectList().add(Aspect.GREED, 2)
                .add(Aspect.METAL, 3)
                .add(Aspect.MOTION, 2)
                .add(Aspect.ENERGY, 4));

        AspectList transAndCapAspects = new AspectList().add(Aspect.ENERGY, 2)
            .add(Aspect.PLANT, 2)
            .add(Aspect.METAL, 6);
        ...
        AspectList pcbAspects = new AspectList().add(Aspect.ENERGY, 1)
            .add(Aspect.PLANT, 2)
            .add(Aspect.METAL, 6);
        ...
        ThaumcraftApi.registerObjectTag(
            new ItemStack(Itemss.airCanister),
            new AspectList().add(Aspect.METAL, 30)
                .add(Aspect.ENERGY, 4));

        /*
         * for(Item item : pcItems) {
         * ThaumcraftApi.registerComplexObjectTag(new ItemStack(item, 1, OreDictionary.WILDCARD_VALUE), new
         * AspectList());
         * }
         * for(Block block : pcBlocks) {
         * ThaumcraftApi.registerComplexObjectTag(new ItemStack(block, 1, OreDictionary.WILDCARD_VALUE), new
         * AspectList());
         * }
         */
    }
