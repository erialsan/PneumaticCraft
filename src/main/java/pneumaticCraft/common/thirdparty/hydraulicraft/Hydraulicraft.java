...
public class Hydraulicraft implements IThirdParty {
    ...
    public void preInit() {
        FMLInterModComms.sendMessage(
            ModIds.HC,
            "pneumaticCraft.common.thirdparty.hydraulicraft.Hydraulicraft",
            "registrarHandling");
        // pneumaticPump = new
        // BlockPneumaticPump(Material.iron).setCreativeTab(pneumaticCraftTab).setBlockName("pneumaticPump").setHardness(3.0F).setResistance(3.0F);
    ...
    public static void registrarHandling(IHydraulicraftRegistrar registrar) {
        ...
        Block pressureCore = GameData.getBlockRegistry()
            .getObject(ModIds.HC + ":LPBlockCore");
        Block pressureWall = GameData.getBlockRegistry()
            .getObject(ModIds.HC + ":hydraulicPressureWall");
        Block hydraulicPiston = GameData.getBlockRegistry()
            .getObject(ModIds.HC + ":hydraulicPiston");
