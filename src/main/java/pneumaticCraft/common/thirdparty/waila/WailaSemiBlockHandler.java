...
public class WailaSemiBlockHandler implements IWailaDataProvider {
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor,
        ...
        ISemiBlock semiBlock = SemiBlockManager.getInstance(accessor.getWorld())
            .getSemiBlock(accessor.getWorld(), x, y, z);
    ...
    public NBTTagCompound getNBTData(EntityPlayerMP player, TileEntity te, NBTTagCompound tag, World world, int x,
        int y, int z) {
        ISemiBlock semiBlock = SemiBlockManager.getInstance(world)
