...
public class ModInteractionUtils {
    ...
    /**
     * Used to get a IPneumaticMachine if the TE is one. When FMP is installed this will also look for a multipart
     * containing IPneumaticMachine.
     * 
     * @param te
     * @return
     */
    ...
    public void removeTube(TileEntity te) {
        te.getWorldObj()
            .setBlockToAir(te.xCoord, te.yCoord, te.zCoord);
    }
