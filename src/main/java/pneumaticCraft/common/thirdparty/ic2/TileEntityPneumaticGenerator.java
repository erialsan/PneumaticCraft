...
public class TileEntityPneumaticGenerator extends TileEntityPneumaticBase
    implements IEnergySource, IWrenchable, IInventory, IRedstoneControlled, IMinWorkingPressure, IHeatExchanger {
    ...
    public TileEntityPneumaticGenerator() {
        super(
            PneumaticValues.DANGER_PRESSURE_PNEUMATIC_GENERATOR,
            PneumaticValues.MAX_PRESSURE_PNEUMATIC_GENERATOR,
            PneumaticValues.VOLUME_PNEUMATIC_GENERATOR);
    ...
    public double getOfferedEnergy() {
        return getPressure(ForgeDirection.UNKNOWN) > PneumaticValues.MIN_PRESSURE_PNEUMATIC_GENERATOR
            && redstoneAllows() ? getEnergyPacketSize() : 0;
    }
