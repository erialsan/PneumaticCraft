...
public class FMPPlacementListener {
    ...
    public void playerInteract(PlayerInteractEvent event) {
        if (!Config.convertMultipartsToBlocks && event.action == Action.RIGHT_CLICK_BLOCK
    ...
    public static boolean place(EntityPlayer player, World world) {
        ...
        if (!world.isRemote) {
            ...
            world.playSoundEffect(
                ...
                pos.y + 0.5,
                pos.z + 0.5,
                Blockss.pressureTube.stepSound.func_150496_b(),
                (Blockss.pressureTube.stepSound.getVolume() + 1.0F) / 2.0F,
                Blockss.pressureTube.stepSound.getPitch() * 0.8F);
