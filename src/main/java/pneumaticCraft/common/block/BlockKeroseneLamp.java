...
public class BlockKeroseneLamp extends BlockAirCompressor {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess blockAccess, int x, int y, int z) {
        ...
        if (facing == ForgeDirection.NORTH || facing == ForgeDirection.SOUTH) {
            setBlockBounds(
                BBConstants.KEROSENE_LAMP_LENGTH_MIN,
                0,
                BBConstants.KEROSENE_LAMP_WIDTH_MIN,
                1 - BBConstants.KEROSENE_LAMP_LENGTH_MIN,
                BBConstants.KEROSENE_LAMP_TOP_MAX,
                1 - BBConstants.KEROSENE_LAMP_WIDTH_MIN);
        } else {
            setBlockBounds(
                BBConstants.KEROSENE_LAMP_WIDTH_MIN,
                0,
