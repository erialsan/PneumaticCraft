...
public class Blockss {
    ...
    public static void init() {
        pressureTube = new BlockPressureTube(
            Material.iron,
            PneumaticValues.DANGER_PRESSURE_PRESSURE_TUBE,
            PneumaticValues.MAX_PRESSURE_PRESSURE_TUBE,
            PneumaticValues.VOLUME_PRESSURE_TUBE).setBlockName("pressureTube");
        advancedPressureTube = new BlockPressureTube(
            Material.iron,
            PneumaticValues.DANGER_PRESSURE_ADVANCED_PRESSURE_TUBE,
            PneumaticValues.MAX_PRESSURE_ADVANCED_PRESSURE_TUBE,
            PneumaticValues.VOLUME_ADVANCED_PRESSURE_TUBE).setBlockName("advancedPressureTube");
        ...
        pressureChamberWall = new BlockPressureChamberWall(Material.iron).setResistance(2000.0F)
            .setBlockName("pressureChamberWall");
        pressureChamberValve = new BlockPressureChamberValve(Material.iron).setResistance(2000.0F)
            .setBlockName("pressureChamberValve");
        ...
        pressureChamberInterface = new BlockPressureChamberInterface(Material.iron).setResistance(2000.0F)
            .setBlockName("pressureChamberInterface");
        ...
        compressedIron = new BlockCompressedIron(Material.iron).setBlockTextureName(Textures.BLOCK_COMPRESSED_IRON)
            .setStepSound(Block.soundTypeMetal)
            .setBlockName("compressedIronBlock");
        ...
        electrostaticCompressor = new BlockElectrostaticCompressor(Material.iron)
            .setBlockName("electrostaticCompressor");
        aphorismTile = new BlockAphorismTile(Material.rock).setHardness(1.5F)
            .setResistance(4.0F)
            .setBlockName("aphorismTile");
        ...
        advancedLiquidCompressor = new BlockAdvancedLiquidCompressor(Material.iron)
            .setBlockName("advancedLiquidCompressor");
        ...
        thermopneumaticProcessingPlant = new BlockThermopneumaticProcessingPlant(Material.iron)
            .setBlockName("thermopneumaticProcessingPlant");
