...
public class EntityRegistrator {
    ...
    public static void init() {
        ...
        EntityRegistry.registerModEntity(
            EntityChopperSeeds.class,
            "Chopper Plant Seeds Entity",
            2,
            ...
            true);
        EntityRegistry
            .registerModEntity(EntityPotionCloud.class, "Potion Cloud", 3, PneumaticCraft.instance, 80, 1, true);
        EntityRegistry.registerModEntity(EntityDrone.class, "Drone", 4, PneumaticCraft.instance, 80, 1, true);
        EntityRegistry
            .registerModEntity(EntityLogisticsDrone.class, "logisticDrone", 5, PneumaticCraft.instance, 80, 1, true);
        // Entity Eggs:
