...
public class EntityTrackHandler {
    ...
    public static void registerDefaultEntries() {
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryLivingBase.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryHackable.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryDrone.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryPressurizable.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryAgeable.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryTameable.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryCreeper.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntrySlime.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryPlayer.class);
        PneumaticRegistry.getInstance()
            .registerEntityTrackEntry(EntityTrackEntryMob.class);
    }
    ...
    public static void init() {
        for (Class<? extends IEntityTrackEntry> clazz : PneumaticCraftAPIHandler.getInstance().entityTrackEntries) {
            try {
                ...
                Log.error(
                    "[Entity Tracker] Couldn't registrate " + clazz.getName()
                        + ". Does it have a parameterless constructor?");
                e.printStackTrace();
    ...
    public static List<IEntityTrackEntry> getTrackersForEntity(Entity entity) {
        ...
        for (IEntityTrackEntry tracker : trackEntries) {
            if (tracker.isApplicable(entity)) {
                try {
                    IEntityTrackEntry newTracker = tracker.getClass()
                        .newInstance();
    ...
    public static class EntityTrackEntryDrone extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            ...
            if (DroneDebugUpgradeHandler.enabledForPlayer(PneumaticCraft.proxy.getPlayer()) && NBTUtil.getInteger(
                PneumaticCraft.proxy.getPlayer()
                    .getCurrentArmor(3),
                NBTKeys.PNEUMATIC_HELMET_DEBUGGING_DRONE) != entity.getEntityId()) {
                curInfo.add(
                    EnumChatFormatting.RED + "Press '"
    ...
    public static class EntityTrackEntryPressurizable extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            curInfo.add(
                "Pressure: " + PneumaticCraftUtils.roundNumberTo(((IPressurizable) entity).getPressure(null), 1)
                    + " bar");
        }
    }
    ...
    public static class EntityTrackEntryLivingBase extends EntityTrackEntry {
        ...
        @Override
        public void addInfo(Entity entity, List<String> curInfo) {
            int healthPercentage = (int) (((EntityLivingBase) entity).getHealth()
    ...
    public static class EntityTrackEntryAgeable extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            ...
            if (growingAge > 0) {
                ...
                curInfo
                    .add("Becomes adult in " + PneumaticCraftUtils.convertTicksToMinutesAndSeconds(-growingAge, false));
            } else {
    ...
    public static class EntityTrackEntryCreeper extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            if (creeperInFuseTime > 0) {
                if (((EntityCreeper) entity).getCreeperState() == 1) {
                    curInfo.add(
                        EnumChatFormatting.RED + "FUSE: "
                            + Math.round((30 - creeperInFuseTime) / 20F * 10F) / 10F
                            + "s !");
                } else {
                    curInfo.add(
                        EnumChatFormatting.DARK_GREEN + "Cooling down: "
                            + Math.round((30 - creeperInFuseTime) / 20F * 10F) / 10F
                            + "s !");
                }
            }
    ...
    public static class EntityTrackEntryHackable extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            ...
            if (hackable != null) {
                List<RenderTarget> targets = HUDHandler.instance()
