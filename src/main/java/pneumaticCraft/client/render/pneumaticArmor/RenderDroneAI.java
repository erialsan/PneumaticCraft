...
public class RenderDroneAI {
    ...
    public void render(float partialTicks) {
        ...
        if (activeProgram != null && pos != null) {
            ...
            renderItem.doRender(
                entityItem,
                getInterpolated(pos.chunkPosX, oldPos.chunkPosX, partialTicks) + 0.5,
                getInterpolated(pos.chunkPosY, oldPos.chunkPosY, partialTicks) + 0.5,
                getInterpolated(pos.chunkPosZ, oldPos.chunkPosZ, partialTicks) + 0.5,
                0,
                partialTicks * 4);
