...
public class GuiSearcher extends InventoryEffectRenderer {
    ...
    private static final ResourceLocation scrollTexture = new ResourceLocation(
    ...
    public GuiSearcher(EntityPlayer par1EntityPlayer) {
        ...
        allowUserInput = true;
        ySize = 176;
        parentScreen = FMLClientHandler.instance()
    ...
    private void updateCreativeSearch() {
        ...
        while (iterator.hasNext()) {
            ...
            boolean flag = false;
            Iterator iterator1 = itemstack.getTooltip(mc.thePlayer, mc.gameSettings.advancedItemTooltips)
                .iterator();
     ...
     * SlotCreativeInventory slotcreativeinventory = new SlotCreativeInventory(this,
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        int l = k + 112;
        mc.getTextureManager()
            .bindTexture(scrollTexture);
        drawTexturedModalRect(
            i1,
            k + (int) ((l - k - 17) * currentScroll),
