...
public class GuiLiquidCompressor extends GuiPneumaticContainerBase<TileEntityLiquidCompressor> {
    ...
    public void initGui() {
        ...
        addAnimatedStat("gui.tab.liquidCompressor.fuel", new ItemStack(Items.lava_bucket), 0xFFFF6600, true)
            .setTextWithoutCuttingString(getAllFuels());
    }
    ...
    protected void addPressureStatInfo(List<String> pressureStatText) {
        ...
        if (te.isProducing) {
            ...
            pressureStatText.add(
                "\u00a70" + (double) Math.round(
                    te.getBaseProduction() * te.getEfficiency()
    ...
    private List<String> getAllFuels() {
        ...
        for (Map.Entry<String, Integer> map : sortByValue(PneumaticCraftAPIHandler.getInstance().liquidFuels)
            .entrySet()) {
