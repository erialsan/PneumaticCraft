...
public class GuiVacuumPump extends GuiPneumaticContainerBase<TileEntityVacuumPump> {
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y) {
        ...
        GuiUtils.drawPressureGauge(
            ...
            PneumaticValues.MIN_PRESSURE_VACUUM_PUMP,
            te.getPressure(te.getInputSide()),
            xStart + xSize * 1 / 5,
            yStart + ySize * 1 / 5 + 4,
            zLevel);
        GuiUtils.drawPressureGauge(
            ...
            PneumaticValues.DANGER_PRESSURE_VACUUM_PUMP,
            -1,
            te.getPressure(te.getVacuumSide()),
            xStart + xSize * 4 / 5,
            yStart + ySize * 1 / 5 + 4,
            zLevel);
    }
    ...
    protected void addPressureStatInfo(List<String> pressureStatText) {
        ...
        pressureStatText
            .add("\u00a70" + (double) Math.round(te.getCurrentAir(te.getVacuumSide()) + te.volume) + " mL.");
        ...
        if (te.turning) {
            ...
            pressureStatText.add(
                "\u00a70" + (double) Math.round(
                    PneumaticValues.PRODUCTION_VACUUM_PUMP * te.getSpeedMultiplierFromUpgrades(te.getUpgradeSlots()))
                    + " mL/tick.");
        }
    }
