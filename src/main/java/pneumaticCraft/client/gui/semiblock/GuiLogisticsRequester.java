        ...
        if (Loader.isModLoaded(ModIds.AE2)) {
            if (logistics.isPlacedOnInterface()) {
                ...
                GuiAnimatedStat stat = addAnimatedStat(
                    "gui.tab.info.logisticsRequester.aeIntegration.title",
                    new ItemStack(item, 1, 16),
                    0xFF00AAFF,
                    false);
                ...
                stat.setText(text);
                stat.addWidget(
                    aeIntegration = new GuiCheckBox(
                        1,
                        16,
                        13,
                        0xFF000000,
                        "gui.tab.info.logisticsRequester.aeIntegration.enable"));
            }
        }
    }
