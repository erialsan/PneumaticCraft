...
public abstract class GuiPneumaticInventoryItem extends GuiPneumaticContainerBase<TileEntityChargingStation> {
    ...
    protected void addPressureStatInfo(List<String> pressureStatText) {
        ...
        float curPressure = ((IPressurizable) itemStack.getItem())
            .getPressure(te.getStackInSlot(TileEntityChargingStation.CHARGE_INVENTORY_INDEX));
        ...
        if (volume > getDefaultVolume()) {
            pressureStatText
                .add("\u00a70" + (double) Math.round(volume - getDefaultVolume()) + " mL. (Volume Upgrades)");
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        fontRendererObj
            .drawString(containerName, xSize / 2 - fontRendererObj.getStringWidth(containerName) / 2, 4, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y) {
        ...
        GuiUtils.drawPressureGauge(
            ...
            10,
            0,
            ((IPressurizable) itemStack.getItem())
                .getPressure(te.getStackInSlot(TileEntityChargingStation.CHARGE_INVENTORY_INDEX)),
            xStart + xSize * 3 / 4 + 8,
            yStart + ySize * 1 / 4 + 4,
            zLevel);
