...
public class GuiProgWidgetArea extends GuiProgWidgetAreaShow<ProgWidgetArea> {
    ...
    public void initGui() {
        ...
        GuiButtonSpecial gpsButton1 = new GuiButtonSpecial(
            0,
            guiLeft + (advancedMode ? 6 : 55),
            guiTop + 20,
            20,
            20,
            "");
        GuiButtonSpecial gpsButton2 = new GuiButtonSpecial(
            1,
            guiLeft + (advancedMode ? 133 : 182),
            guiTop + 20,
            20,
            20,
            "");
        ...
        variableField1 = new WidgetComboBox(
            fontRendererObj,
            guiLeft + 28,
            guiTop + 25,
            88,
            fontRendererObj.FONT_HEIGHT + 1);
        variableField2 = new WidgetComboBox(
            fontRendererObj,
            guiLeft + 155,
            guiTop + 25,
            88,
        ...
        typeInfoField = new WidgetTextFieldNumber(
            fontRendererObj,
            guiLeft + 160,
            guiTop + 110,
            20,
