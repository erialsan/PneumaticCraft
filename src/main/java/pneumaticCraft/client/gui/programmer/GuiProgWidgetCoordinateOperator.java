...
public class GuiProgWidgetCoordinateOperator extends GuiProgWidgetAreaShow<ProgWidgetCoordinateOperator> {
    ...
    public void initGui() {
        ...
        for (int i = 0; i < EnumOperator.values().length; i++) {
            GuiRadioButton radioButton = new GuiRadioButton(
                ...
                guiTop + 42 + 12 * i,
                0xFF000000,
                I18n.format(EnumOperator.values()[i].getUnlocalizedName()));
            radioButtons.add(radioButton);
            radioButton.checked = widget.getOperator()
                .ordinal() == i;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        fontRendererObj
            .drawString(I18n.format("gui.progWidget.coordinate.variableName"), guiLeft + 90, guiTop + 30, 0xFF000000);
        fontRendererObj.drawString(
            I18n.format("gui.progWidget.coordinateOperator.operator"),
            guiLeft + 7,
            guiTop + 30,
            0xFF000000);
    }
