...
public class GuiProgWidgetDigAndPlace<Widget extends ProgWidgetDigAndPlace> extends GuiProgWidgetAreaShow<Widget> {
    ...
    public void initGui() {
        ...
        useMaxActions = new GuiCheckBox(
            16,
            guiLeft + (moveActionsToSide() ? 54 : 4),
            guiTop + 115,
            0xFF000000,
            I18n.format("gui.progWidget.digAndPlace.useMaxActions"));
        ...
        textField = new WidgetTextFieldNumber(
            Minecraft.getMinecraft().fontRenderer,
            guiLeft + (moveActionsToSide() ? 57 : 7),
            guiTop + 128,
            50,
            11);
