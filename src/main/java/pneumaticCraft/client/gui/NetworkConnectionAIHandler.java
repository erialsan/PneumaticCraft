...
public class NetworkConnectionAIHandler extends NetworkConnectionHandler {
    ...
    public void update() {
        ...
        if (tracing) {
            for (int i = 0; i < 35; i++) tryToHackSlot(i);
    ...
    public void onSlotHack(int slot, boolean nuked) {
        if (!simulating && station.getStackInSlot(slot) != null
                ...
                .getClient().thePlayer.addChatComponentMessage(
                    new ChatComponentTranslation(
                        EnumChatFormatting.RED
                            + "Hacking unsuccessful! The Diagnostic Subroutine traced to your location!"));
