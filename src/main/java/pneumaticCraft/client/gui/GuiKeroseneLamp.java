...
public class GuiKeroseneLamp extends GuiPneumaticContainerBase<TileEntityKeroseneLamp> {
    ...
    public void initGui() {
        ...
        addWidget(
            rangeWidget = new WidgetTextFieldNumber(
                fontRendererObj,
                guiLeft + 7 + maxRangeLength,
                guiTop + 50,
                30,
    ...
    public void updateScreen() {
        ...
        /*
         * if(te.getRange() > 0) {
         * int ticksLeft = (int)(te.getTank().getFluidAmount() * TileEntityKeroseneLamp.FUEL_PER_MB * 5 /
         * Math.pow(te.getRange(), 3));
         * timeLeftWidget.text = I18n.format("gui.keroseneLamp.timeLeft",
         * PneumaticCraftUtils.convertTicksToMinutesAndSeconds(ticksLeft, false));
         * } else {
         * timeLeftWidget.text = "";
         * }
         */
