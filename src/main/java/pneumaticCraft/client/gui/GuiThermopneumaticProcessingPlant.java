...
public class GuiThermopneumaticProcessingPlant
    extends GuiPneumaticContainerBase<TileEntityThermopneumaticProcessingPlant> {

    private WidgetTemperature tempWidget;

    public GuiThermopneumaticProcessingPlant(InventoryPlayer player, TileEntityThermopneumaticProcessingPlant te) {
        super(
            new ContainerThermopneumaticProcessingPlant(player, te),
            te,
            Textures.GUI_THERMOPNEUMATIC_PROCESSING_PLANT);
        ySize = 197;
    }
    ...
    public void initGui() {
        ...
        addWidget(
            tempWidget = new WidgetTemperature(
                ...
                273,
                673,
                te.getHeatExchangerLogic(ForgeDirection.UNKNOWN),
                (int) te.requiredTemperature));
    }
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        fontRendererObj
            .drawString(containerName, xSize / 2 - fontRendererObj.getStringWidth(containerName) / 2 + 1, 5, 4210752);
        GL11.glPopMatrix();
    ...
    public void addProblems(List<String> curInfo) {
        ...
        } else if (te.getHeatExchangerLogic(ForgeDirection.UNKNOWN)
            .getTemperature() < te.requiredTemperature) {
