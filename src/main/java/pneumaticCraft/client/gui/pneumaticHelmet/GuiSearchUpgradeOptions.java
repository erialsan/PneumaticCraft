...
public class GuiSearchUpgradeOptions implements IOptionPage {
    ...
    private final EntityPlayer player = FMLClientHandler.instance()
        .getClient().thePlayer;
    ...
    public void initGui(IGuiScreen gui) {
        gui.getButtonList()
            .add(new GuiButton(10, 30, 40, 150, 20, "Search for item..."));
        gui.getButtonList()
            .add(new GuiButton(11, 30, 128, 150, 20, "Move Stat Screen..."));
        if (searchGui != null && player.getCurrentArmor(3) != null) {
            ...
            if (searchStack == null && helmetStack != null || searchStack != null && helmetStack == null
                || searchStack != null && helmetStack != null && !searchStack.isItemEqual(helmetStack)) {
