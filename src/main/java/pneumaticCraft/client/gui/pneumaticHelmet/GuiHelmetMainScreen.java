...
public class GuiHelmetMainScreen extends GuiPneumaticScreenBase implements IGuiScreen {
    ...
    private static GuiHelmetMainScreen instance;// Creating a static instance, as we can use it to handle keybinds when
                                                // the GUI is closed.
    ...
    public void initGui() {
        ...
        GuiKeybindCheckBox checkBox = new GuiKeybindCheckBox(
            100,
            40,
            12,
            0xFFFFFFFF,
        ...
        if (upgradePages.get(page)
            .canBeTurnedOff()) addWidget(checkBox);
        upgradePages.get(page)
            .initGui(this);
    }
