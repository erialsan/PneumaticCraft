...
public class GuiPressureModuleSimple extends GuiTubeModule {
    ...
    public void initGui() {
        ...
        thresholdField = new WidgetTextFieldNumber(
            fontRendererObj,
            guiLeft + 110,
            guiTop + 33,
            30,
            fontRendererObj.FONT_HEIGHT).setDecimals(1);
        ...
        if (module instanceof TubeModuleRedstoneReceiving) {
            ...
            moreOrLessButton = new GuiButtonSpecial(
                1,
                guiLeft + 85,
                guiTop + 28,
                20,
                20,
                module.lowerBound < module.higherBound ? ">" : "<");
            moreOrLessButton.setTooltipText(
                I18n.format(
                    module.lowerBound < module.higherBound ? "gui.tubeModule.simpleConfig.higherThan"
                        : "gui.tubeModule.simpleConfig.lowerThan"));
