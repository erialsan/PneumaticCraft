...
public class RenderUtils extends Render {
    ...
    public void renderLiquid(FluidTankInfo info, RenderInfo renderInfo, World worldObj) {
        if (info.fluid.getFluid()
            .getBlock() != null) {
            renderInfo.baseBlock = info.fluid.getFluid()
                .getBlock();
        } else {
            renderInfo.baseBlock = Blocks.water;
        }
        renderInfo.texture = info.fluid.getFluid()
            .getIcon(info.fluid);
    ...
    /**
     * This method is derived from BuildCraft's RenderEntityBlock.java, found at
     * https://github.com/BuildCraft/BuildCraft/blob/6.1.x/common/buildcraft/core/render/RenderEntityBlock.java
    ...
    /**
     * This class is derived from BuildCraft's RenderEntityBlock.java, found at
     * https://github.com/BuildCraft/BuildCraft/blob/6.1.x/common/buildcraft/core/render/RenderEntityBlock.java
     * This is edited by @author MineMaarten.
     * 
     * @param info
