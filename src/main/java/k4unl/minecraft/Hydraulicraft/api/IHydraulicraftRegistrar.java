...
/**
 * Use this class to register content to Hydraulicraft. The system uses IMC. Create a class that has the following
 * signature:
 * 
 * package aaa.bbb.ccc;
...
public interface IHydraulicraftRegistrar {
    ...
    /**
     * Use this to get the trolley item that's associated with the key. This key is the same as the one returned in
     * {@link IHarvesterTrolley#getName()}.
